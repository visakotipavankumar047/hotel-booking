        ...
        <div className={"py-28 mb:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32"}>
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking) => (
                    <div key={booking} className={"grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t"}>
                        {/*Hotel Details*/}
                        <div className={"flex flex-col md:flex-row"}>
                            ...
                            <div className={"flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4"}>
                                ...
                                <div className={"flex items-center gap-1 text-sm text-gray-500"}>
                                    <img src={assets.guestsIcon} alt="loaction-icon" />
